# Hands-on/how-to topics {-}

The following are potential hands-on/how-to topics we are considering for [Day 2](#day_2).
These are also topics that might be offered later on after the bootcamp.

The person indicated in the parentheses is the tentative coordinator for that workshop as of `r Sys.Date()`. 
...
## Reproducibility (?) {- #howto_reproducibility}
...
## Version control with git, GitHub, and GitLab ([Alaina Pearce]?) {- #howto_git}
...
## Where to start? Open science for early career researchers ([Daisy Lei]? & [Hollie Mullin?]) {- #howto_early_career}
