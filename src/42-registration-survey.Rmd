...
```{r by-position, fig.cap="Day 1 registrations vs. attendees by position"}
registrations_yes |>
...
```{r by-dept, fig.cap="Day 1 attendance vs. registrations by department and college"}
...
```{r regisrations-timeseries, fig.cap="Registrations vs. Day 1 attendance by department and college"}
registrations_yes |>
...
```{r, include = FALSE}
xtabs(~ college + Day_1, registrations_yes)
```
