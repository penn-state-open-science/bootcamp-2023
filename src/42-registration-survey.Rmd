...
registrations_yes <- registrations_yes |>
  tidyr::pivot_longer(cols = contains("Day_"), names_to = "attended_day", values_to = "yes_no") |>
...
```{r regisrations-timeseries, fig.cap="Registrations vs. attendance by department and college"}
registrations_yes |>
...
```{r, include = FALSE}
xtabs(~ college + attended_day, registrations_yes)
```
