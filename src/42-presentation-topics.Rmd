...
### Literate Programming with R Markdown and Quarto ([Rick Gilmore] & [Alaina Pearce]?){- #howto_rmarkdown}
...
Best practices can be hard to implement, so what open science practices are both ueseful and "good enough" [@Wilson2017-ot] to have an impact on your work? How can researchers make their data findable, accessible, interoperable, and reusable--adhere to the FAIR data principles [@Wilkinson2016-qr]?
...
How can early career researchers start easing-in to their open science journey [@Kathawalla2021-tk]?
